...
(function (spine) {
    ...
    (function (babylonjs) {
        var AssetManager = (function (_super) {
            ...
            function AssetManager(scene, pathPrefix) {
                if (pathPrefix === void 0) { pathPrefix = ""; }
                return _super.call(this, function (image) {
                    return new babylonjs.BabylonJsTexture(image, scene);
                }, pathPrefix) || this;
            }
            return AssetManager;
        }(spine.AssetManager));
        babylonjs.AssetManager = AssetManager;
    })(babylonjs = spine.babylonjs || (spine.babylonjs = {}));
})(spine || (spine = {}));
var spine;
(function (spine) {
    var babylonjs;
    (function (babylonjs) {
        var BabylonJsTexture = (function (_super) {
            __extends(BabylonJsTexture, _super);
            function BabylonJsTexture(image, scene) {
                var _this = _super.call(this, image) || this;
                var invertY = false;
                _this.texture = new BABYLON.Texture(image.src, scene, false, invertY);
                _this.texture.hasAlpha = true;
                return _this;
            }
            BabylonJsTexture.prototype.setFilters = function (minFilter, magFilter) {
            };
            BabylonJsTexture.prototype.setWraps = function (uWrap, vWrap) {
                this.texture.wrapU = BABYLON.Texture.CLAMP_ADDRESSMODE;
                this.texture.wrapV = BABYLON.Texture.CLAMP_ADDRESSMODE;
            };
            BabylonJsTexture.prototype.dispose = function () {
                this.texture.dispose();
            };
            BabylonJsTexture.toBabylonJsTextureFilter = function (filter) {
            ...
            BabylonJsTexture.toBabylonJsTextureWrap = function (wrap) {
            ...
            return BabylonJsTexture;
        }(spine.Texture));
        babylonjs.BabylonJsTexture = BabylonJsTexture;
    })(babylonjs = spine.babylonjs || (spine.babylonjs = {}));
})(spine || (spine = {}));
var spine;
(function (spine) {
    ...
    (function (babylonjs) {
        var MeshBatcher = (function (_super) {
            ...
            function MeshBatcher(name, scene, maxVertices) {
                if (maxVertices === void 0) { maxVertices = 10920; }
                var _this = _super.call(this, name, scene) || this;
                _this.depth = 0;
                _this.verticesLength = 0;
                _this.indicesLength = 0;
                _this.maxVerticesLength = 0;
                _this.maxIndicesLength = 0;
                if (maxVertices > 10920)
                    throw new Error("Can't have more than 10920 triangles per batch: " + maxVertices);
                _this.layerMask = 1;
                _this.maxVerticesLength = maxVertices * MeshBatcher.VERTEX_SIZE * Float32Array.BYTES_PER_ELEMENT;
                _this.maxIndicesLength = maxVertices * 3 * Uint16Array.BYTES_PER_ELEMENT;
            ...
            Object.defineProperty(MeshBatcher.prototype, "is", {
                get: function () {
                    return 'MeshBatcher';
                },
                enumerable: true,
        ...
        babylonjs.MeshBatcher = MeshBatcher;
    })(babylonjs = spine.babylonjs || (spine.babylonjs = {}));
})(spine || (spine = {}));
var spine;
(function (spine) {
    ...
    (function (babylonjs) {
        var SkeletonMeshMaterial = (function (_super) {
            ...
            function SkeletonMeshMaterial(name, scene) {
                var _this = this;
                var route = {
                    vertex: "custom",
                    fragment: "custom",
                ...
                _this = _super.call(this, name, scene, route, options) || this;
        ...
        babylonjs.SkeletonMeshMaterial = SkeletonMeshMaterial;
        var SkeletonMesh = (function (_super) {
            __extends(SkeletonMesh, _super);
            function SkeletonMesh(name, scene, skeletonData) {
                var _this = _super.call(this, name, scene) || this;
                _this.zOffset = -0.1;
                _this.onPickDownObservable = new BABYLON.Observable();
                _this.batches = new Array();
                _this.nextBatchIndex = 0;
                _this.vertices = spine.Utils.newFloatArray(8 * 4);
                _this.tempColor = new spine.Color();
                _this.spineSkeleton = new spine.Skeleton(skeletonData);
                var animData = new spine.AnimationStateData(skeletonData);
                _this.state = new spine.AnimationState(animData);
                _this.billboardMode = BABYLON.Mesh.BILLBOARDMODE_ALL;
                return _this;
            }
            SkeletonMesh.prototype.getClassName = function () {
                return "SkeletonMesh";
            };
            SkeletonMesh.prototype.setDepth = function (d) {
            ...
            SkeletonMesh.prototype.update = function (deltaTime) {
                ...
                var skeleton = this.spineSkeleton;
            ...
            SkeletonMesh.prototype.nextBatch = function () {
                ...
                if (this.batches.length == this.nextBatchIndex) {
                    var batch_1 = new babylonjs.MeshBatcher('batcher_' + Date.now(), this.getScene());
                    batch_1.parent = this;
                    var onPickDown = new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPickDownTrigger, function (evt) {
                        var pickInfo = _this.getScene().pick(evt.pointerX, evt.pointerY, function (mesh) {
                            return true;
                        });
                        _this.onPickDownObservable.notifyObservers({ name: _this.name, pickedPoint: pickInfo.pickedPoint });
                    });
                    batch_1.actionManager.registerAction(onPickDown);
                    this.batches.push(batch_1);
                    batch_1.material.freeze();
                }
            ...
            SkeletonMesh.prototype.updateGeometry = function () {
                ...
                var triangles = null;
                var uvs = null;
                var drawOrder = this.spineSkeleton.drawOrder;
                var batch = this.nextBatch();
                batch.begin();
                var z = 0;
                var zOffset = this.zOffset;
                for (var i = 0, n = drawOrder.length; i < n; i++) {
                    var vertexSize = SkeletonMesh.VERTEX_SIZE;
                    var slot = drawOrder[i];
                    var attachment = slot.getAttachment();
        ...
        babylonjs.SkeletonMesh = SkeletonMesh;
    })(babylonjs = spine.babylonjs || (spine.babylonjs = {}));
})(spine || (spine = {}));
//# sourceMappingURL=spine-babylonjs.js.map